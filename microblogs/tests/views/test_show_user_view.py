...
class ShowUserTest(TestCase):
    ...
    def setUp(self):
        ...
        self.target_user = User.objects.get(username='Jane123')
    ...
    def test_get_show_user_with_valid_id(self):
        ...
        self.assertContains(response, "Jane123")
    ...
    def test_get_show_user_with_own_id(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'show_user.html')
        self.assertContains(response, "Aniad Hossain")
        self.assertContains(response, "Aniad123")
        followable = response.context['followable']
    ...
    def test_show_user_displays_posts_belonging_to_the_shown_user_only(self):
        self.client.login(username=self.user.username, password='Password123')
        other_user = User.objects.get(username='Jane123')
